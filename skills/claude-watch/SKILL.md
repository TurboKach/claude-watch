...
3. **`advise` never scans.** A disk domain carrying `cache_missing` means you *tell the user* to run `claude-watch disk --refresh` (~60-70s, cached 6h). Do not run it for them, and do not treat the absent scan as an absence of problems.
